...
sats = Table.read(
    "C:/Users/romix/Documents/GitHub/DeltaSigma2023/data/remapper_cat+mem/dr8_members.fit")
clusters = Table.read(
    "C:/Users/romix/Documents/GitHub/DeltaSigma2023/data/remapper_cat+mem/dr8_cat.fit")
...
for match_id in sats['ID']:
    ...
    if match_id not in cluster_dic:
        ...
        mass = math.exp(1.72)*(richness/60)**(1.08)*10**(14)  # changed to rykoff 2012 B4
...
sats.write('C:/Users/romix/Documents/GitHub/DeltaSigma2023/forJack/members_n_clusters_200m.fits', overwrite=True)
